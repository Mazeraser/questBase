...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        [SerializeField] protected StandaloneInputModule currentStandaloneInputModule;

        //protected ITriggerDialogueInteraction triggerDialogueInteraction;
        ...
        protected virtual void Update()
        {
            ...
            {
                currentStandaloneInputModule = FindObjectOfType<EventSystem>().GetComponent<StandaloneInputModule>();
            }
